...
export const en = {
    ...
    errors: {
        ...
        localSpeechRecognitionUnavailable: 'Speech recognition is not installed or enabled. Install or enable an Android speech recognition service, then try again.',
        localSpeechRecognitionPermissionDenied: 'Microphone access is required for voice input. Enable it in Android settings, then try again.',
        localSpeechRecognitionFailed: 'Speech recognition failed. Check the Android speech service and try again.',
        localSpeechRecognitionModelRequired: 'Offline speech data for this language is missing. Continue to download it in Android, then try voice input again.',
        localSpeechRecognitionModelReady: 'Speech data is ready. Tap the microphone and speak again.',
        localSpeechRecognitionModelDialogOpened: 'Android opened the speech data download screen. Complete the download there, then return and try the microphone again.',
        localSpeechRecognitionModelDownloadFailed: 'Android could not download speech data. Check the speech service or install the language in system settings.',
        localTextToSpeechUnavailable: 'Text-to-speech is not installed or enabled. This reply will remain available as text.',
