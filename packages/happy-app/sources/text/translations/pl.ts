...
export const pl: TranslationStructure = {
    ...
    errors: {
        ...
        localSpeechRecognitionUnavailable: 'Rozpoznawanie mowy nie jest zainstalowane lub włączone. Zainstaluj albo włącz usługę rozpoznawania mowy Androida i spróbuj ponownie.',
        localSpeechRecognitionPermissionDenied: 'Dostęp do mikrofonu jest wymagany do wprowadzania głosowego. Włącz go w ustawieniach Androida i spróbuj ponownie.',
        localSpeechRecognitionFailed: 'Rozpoznawanie mowy nie powiodło się. Sprawdź usługę mowy Androida i spróbuj ponownie.',
        localSpeechRecognitionModelRequired: 'Brakuje danych mowy offline dla tego języka. Kontynuuj, aby pobrać je w Androidzie, a następnie ponów wprowadzanie głosowe.',
        localSpeechRecognitionModelReady: 'Dane mowy są gotowe. Dotknij mikrofonu i powiedz ponownie.',
        localSpeechRecognitionModelDialogOpened: 'Android otworzył ekran pobierania danych mowy. Dokończ tam pobieranie, wróć do aplikacji i ponownie użyj mikrofonu.',
        localSpeechRecognitionModelDownloadFailed: 'Android nie mógł pobrać danych mowy. Sprawdź usługę mowy lub zainstaluj język w ustawieniach systemu.',
        localTextToSpeechUnavailable: 'Synteza mowy nie jest zainstalowana lub włączona. Odpowiedź pozostanie dostępna jako tekst.',
