...
export const ru: TranslationStructure = {
    ...
    errors: {
        ...
        localSpeechRecognitionUnavailable: 'Распознавание речи не установлено или не включено. Установите или включите службу распознавания речи Android и повторите попытку.',
        localSpeechRecognitionPermissionDenied: 'Для голосового ввода нужен доступ к микрофону. Включите его в настройках Android и повторите попытку.',
        localSpeechRecognitionFailed: 'Не удалось распознать речь. Проверьте службу распознавания речи Android и повторите попытку.',
        localSpeechRecognitionModelRequired: 'Для этого языка отсутствуют офлайн-данные речи. Продолжите, чтобы скачать их в Android, затем повторите голосовой ввод.',
        localSpeechRecognitionModelReady: 'Данные речи готовы. Нажмите микрофон и скажите ещё раз.',
        localSpeechRecognitionModelDialogOpened: 'Android открыл экран загрузки речевых данных. Завершите загрузку там, вернитесь в приложение и снова нажмите микрофон.',
        localSpeechRecognitionModelDownloadFailed: 'Android не удалось скачать данные речи. Проверьте службу речи или установите язык в настройках системы.',
        localTextToSpeechUnavailable: 'Синтез речи не установлен или не включён. Ответ останется доступен в виде текста.',
