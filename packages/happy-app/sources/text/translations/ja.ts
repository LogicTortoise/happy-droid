...
export const ja: TranslationStructure = {
    ...
    errors: {
        ...
        localSpeechRecognitionUnavailable: '音声認識がインストールまたは有効化されていません。Android の音声認識サービスをインストールまたは有効化して、もう一度お試しください。',
        localSpeechRecognitionPermissionDenied: '音声入力にはマイクへのアクセスが必要です。Android の設定で有効にして、もう一度お試しください。',
        localSpeechRecognitionFailed: '音声認識に失敗しました。Android の音声サービスを確認して、もう一度お試しください。',
        localSpeechRecognitionModelRequired: 'この言語のオフライン音声データがありません。続行して Android にダウンロードしてから、音声入力を再試行してください。',
        localSpeechRecognitionModelReady: '音声データの準備ができました。マイクをタップしてもう一度話してください。',
        localSpeechRecognitionModelDialogOpened: 'Android の音声データダウンロード画面を開きました。そこでダウンロードを完了してからアプリに戻り、もう一度マイクを試してください。',
        localSpeechRecognitionModelDownloadFailed: 'Android で音声データをダウンロードできませんでした。音声サービスを確認するか、システム設定で言語をインストールしてください。',
        localTextToSpeechUnavailable: 'テキスト読み上げがインストールまたは有効化されていません。返信はテキストとして引き続き表示されます。',
