...
export const ca: TranslationStructure = {
    ...
    errors: {
        ...
        localSpeechRecognitionUnavailable: 'El reconeixement de veu no està instal·lat o activat. Instal·la o activa un servei de reconeixement de veu d\'Android i torna-ho a provar.',
        localSpeechRecognitionPermissionDenied: 'Cal accés al micròfon per a l\'entrada de veu. Activa\'l a la configuració d\'Android i torna-ho a provar.',
        localSpeechRecognitionFailed: 'El reconeixement de veu ha fallat. Comprova el servei de veu d\'Android i torna-ho a provar.',
        localSpeechRecognitionModelRequired: 'Falten les dades de veu fora de línia per a aquest idioma. Continua per baixar-les a Android i torna a provar l\'entrada de veu.',
        localSpeechRecognitionModelReady: 'Les dades de veu estan preparades. Toca el micròfon i torna a parlar.',
        localSpeechRecognitionModelDialogOpened: 'Android ha obert la pantalla de baixada de dades de veu. Completa-hi la baixada, torna a l\'aplicació i prova de nou el micròfon.',
        localSpeechRecognitionModelDownloadFailed: 'Android no ha pogut baixar les dades de veu. Comprova el servei de veu o instal·la l\'idioma a la configuració del sistema.',
        localTextToSpeechUnavailable: 'La conversió de text a veu no està instal·lada o activada. La resposta continuarà disponible com a text.',
