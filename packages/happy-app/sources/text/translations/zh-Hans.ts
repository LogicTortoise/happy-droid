...
export const zhHans: TranslationStructure = {
    ...
    errors: {
        ...
        localSpeechRecognitionUnavailable: '未安装或未启用语音识别。请安装或启用 Android 语音识别服务后重试。',
        localSpeechRecognitionPermissionDenied: '语音输入需要麦克风权限。请在 Android 设置中启用后重试。',
        localSpeechRecognitionFailed: '语音识别失败。请检查 Android 语音服务后重试。',
        localSpeechRecognitionModelRequired: '缺少此语言的离线语音数据。继续在 Android 中下载，然后再次尝试语音输入。',
        localSpeechRecognitionModelReady: '语音数据已就绪。点击麦克风并重新说话。',
        localSpeechRecognitionModelDialogOpened: 'Android 已打开语音数据下载界面。请在那里完成下载，返回应用后再次点击麦克风。',
        localSpeechRecognitionModelDownloadFailed: 'Android 无法下载语音数据。请检查语音服务，或在系统设置中安装该语言。',
        localTextToSpeechUnavailable: '未安装或未启用文字转语音服务。本次回复仍会以文字显示。',
