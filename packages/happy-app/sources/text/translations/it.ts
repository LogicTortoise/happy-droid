...
export const it: TranslationStructure = {
    ...
    settingsFeatures: {
        ...
        attachments: 'Allegati file',
        attachmentsSubtitle: 'Allega immagini, file e documenti per farli analizzare dagli agenti supportati',
    },
    ...
    errors: {
        ...
        localSpeechRecognitionUnavailable: 'Il riconoscimento vocale non è installato o abilitato. Installa o abilita un servizio di riconoscimento vocale Android e riprova.',
        localSpeechRecognitionPermissionDenied: 'L\'accesso al microfono è necessario per l\'input vocale. Abilitalo nelle impostazioni Android e riprova.',
        localSpeechRecognitionFailed: 'Il riconoscimento vocale non è riuscito. Controlla il servizio vocale Android e riprova.',
        localSpeechRecognitionModelRequired: 'Mancano i dati vocali offline per questa lingua. Continua per scaricarli su Android, quindi riprova l\'input vocale.',
        localSpeechRecognitionModelReady: 'I dati vocali sono pronti. Tocca il microfono e parla di nuovo.',
        localSpeechRecognitionModelDialogOpened: 'Android ha aperto la schermata per scaricare i dati vocali. Completa il download, torna nell\'app e riprova il microfono.',
        localSpeechRecognitionModelDownloadFailed: 'Android non ha potuto scaricare i dati vocali. Controlla il servizio vocale o installa la lingua nelle impostazioni di sistema.',
        localTextToSpeechUnavailable: 'La sintesi vocale non è installata o abilitata. La risposta resterà disponibile come testo.',
    ...
    attachments: {
        permissionTitle: 'Accesso agli allegati',
        permissionMessage: "Consenti l'accesso per allegare file ai messaggi.",
        limitTitle: 'Limite allegati raggiunto',
        limitMessage: ({ max }: { max: number }) => `Puoi allegare fino a ${max} file per messaggio.`,
        ...
        uploadFailedMessage: ({ count }: { count: number }) => count === 1
            ? 'Un allegato non è stato caricato e non è stato inviato.'
            : `Non è stato possibile caricare ${count} allegati e non sono stati inviati.`,
        notSupportedTitle: 'Allegati non supportati',
        notSupportedMessage: 'Questo agente non supporta gli allegati file. Gli allegati non sono stati inviati.',
    },
