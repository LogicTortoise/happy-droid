...
export const es: TranslationStructure = {
    ...
    errors: {
        ...
        localSpeechRecognitionUnavailable: 'El reconocimiento de voz no está instalado o habilitado. Instala o habilita un servicio de reconocimiento de voz de Android e inténtalo de nuevo.',
        localSpeechRecognitionPermissionDenied: 'Se necesita acceso al micrófono para la entrada de voz. Habilítalo en los ajustes de Android e inténtalo de nuevo.',
        localSpeechRecognitionFailed: 'El reconocimiento de voz falló. Comprueba el servicio de voz de Android e inténtalo de nuevo.',
        localSpeechRecognitionModelRequired: 'Faltan los datos de voz sin conexión para este idioma. Continúa para descargarlos en Android y vuelve a probar la entrada de voz.',
        localSpeechRecognitionModelReady: 'Los datos de voz están listos. Toca el micrófono y vuelve a hablar.',
        localSpeechRecognitionModelDialogOpened: 'Android abrió la pantalla de descarga de datos de voz. Completa allí la descarga, vuelve a la aplicación y prueba de nuevo el micrófono.',
        localSpeechRecognitionModelDownloadFailed: 'Android no pudo descargar los datos de voz. Comprueba el servicio de voz o instala el idioma en los ajustes del sistema.',
        localTextToSpeechUnavailable: 'La conversión de texto a voz no está instalada o habilitada. La respuesta seguirá disponible como texto.',
    ...
    newSession: {
        ...
        initialMessageNotReady: 'La sesión todavía no está lista para recibir el primer mensaje.',
        initialMessageCancelEvent: 'El primer mensaje no se envió. El prompt se restauró en la pantalla de nueva sesión.',
        initialMessageTimeout: 'Se agotó el tiempo al enviar el primer mensaje. Inténtalo de nuevo.',
        initialMessageRecoveryMessage: ({ message }: { message: string }) =>
            `La sesión se creó, pero el primer mensaje no se confirmó. El prompt se restauró para que puedas reintentarlo.\n\n${message}`,
        retryInitialMessageTitle: '¿Reintentar el primer mensaje?',
        retryInitialMessageMessage: 'Se creó una sesión anterior, pero su primer mensaje no se confirmó. ¿Quieres reintentarlo ahora?',
    },
