...
export const zhHant: TranslationStructure = {
    ...
    errors: {
        ...
        localSpeechRecognitionUnavailable: '未安裝或未啟用語音辨識。請安裝或啟用 Android 語音辨識服務後再試一次。',
        localSpeechRecognitionPermissionDenied: '語音輸入需要麥克風權限。請在 Android 設定中啟用後再試一次。',
        localSpeechRecognitionFailed: '語音辨識失敗。請檢查 Android 語音服務後再試一次。',
        localSpeechRecognitionModelRequired: '缺少此語言的離線語音資料。繼續在 Android 中下載，然後再次嘗試語音輸入。',
        localSpeechRecognitionModelReady: '語音資料已就緒。點擊麥克風並重新說話。',
        localSpeechRecognitionModelDialogOpened: 'Android 已開啟語音資料下載畫面。請在該畫面完成下載，返回應用程式後再次點擊麥克風。',
        localSpeechRecognitionModelDownloadFailed: 'Android 無法下載語音資料。請檢查語音服務，或在系統設定中安裝該語言。',
        localTextToSpeechUnavailable: '未安裝或未啟用文字轉語音服務。此回覆仍會以文字顯示。',
