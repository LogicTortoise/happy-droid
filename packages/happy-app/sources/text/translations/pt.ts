...
export const pt: TranslationStructure = {
    ...
    settingsFeatures: {
        ...
        attachmentsSubtitle: 'Anexe imagens, arquivos e documentos para que agentes compatíveis os analisem',
    },
    ...
    errors: {
        ...
        localSpeechRecognitionUnavailable: 'O reconhecimento de fala não está instalado ou ativado. Instale ou ative um serviço de reconhecimento de fala do Android e tente novamente.',
        localSpeechRecognitionPermissionDenied: 'O acesso ao microfone é necessário para a entrada de voz. Ative-o nas configurações do Android e tente novamente.',
        localSpeechRecognitionFailed: 'O reconhecimento de fala falhou. Verifique o serviço de voz do Android e tente novamente.',
        localSpeechRecognitionModelRequired: 'Faltam dados de fala offline para este idioma. Continue para baixá-los no Android e tente a entrada de voz novamente.',
        localSpeechRecognitionModelReady: 'Os dados de fala estão prontos. Toque no microfone e fale novamente.',
        localSpeechRecognitionModelDialogOpened: 'O Android abriu o ecrã de transferência dos dados de voz. Conclua a transferência, volte à aplicação e tente novamente o microfone.',
        localSpeechRecognitionModelDownloadFailed: 'O Android não conseguiu baixar os dados de fala. Verifique o serviço de voz ou instale o idioma nas configurações do sistema.',
        localTextToSpeechUnavailable: 'A conversão de texto em fala não está instalada ou ativada. A resposta continuará disponível como texto.',
    ...
    attachments: {
        permissionTitle: 'Acesso a anexos',
        permissionMessage: 'Permita o acesso para anexar arquivos às mensagens.',
        limitTitle: 'Limite de anexos atingido',
        limitMessage: ({ max }: { max: number }) => `Você pode anexar até ${max} arquivos por mensagem.`,
        ...
        uploadFailedMessage: ({ count }: { count: number }) => count === 1
            ? 'Não foi possível enviar um anexo e ele não foi enviado.'
            : `Não foi possível enviar ${count} anexos e eles não foram enviados.`,
        notSupportedTitle: 'Anexos não suportados',
        notSupportedMessage: 'Este agente não suporta anexos de arquivo. Os anexos não foram enviados.',
    },
